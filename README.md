...
`tap-pokemon` is a Singer tap for Pokemon.
...
```bash
pipx install tap-pokemon
```

Install from GitHub:

```bash
pipx install git+https://github.com/ORG_NAME/tap-pokemon.git@main
```
...
```
tap-pokemon --about --format=markdown
```
-->
